...
public class VoidCrucibleRenderer extends TileEntitySpecialRenderer implements
	...
	private static final ResourceLocation skyTexture = new ResourceLocation("textures/environment/end_sky.png");
	...
	// Vanilla Method
	private FloatBuffer calcFloatBuffer(float p_147525_1_, float p_147525_2_,
			float p_147525_3_, float p_147525_4_) {
		this.floatBuffer.clear();
		this.floatBuffer.put(p_147525_1_).put(p_147525_2_).put(p_147525_3_)
				.put(p_147525_4_);
